...
#    INSTALL
#
#    1. Move the MS_ShotSculptor_PY2.py file to your maya scripts directory. 
#
#        found at:
...
#
#    4. select the shelf you would like to add the button to. Drag and drop the install_PY2.py file into maya 
#   
#                ----------------------- OR -----------------------
#                
#                
#    1. Open the MS_ShotSculptor_PY2.py in a python tab of the script editor
#    
#    2. Run the script
#    
#    
